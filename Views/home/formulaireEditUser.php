        ...
        <form class="needs-validation" id="addUserForm" method="POST">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="text" class="form-control" id="nom" name="nom" value="<?=$users->nom?>" required>
              <small></small>
            </div>
            ...
            <div class="col-12 mb-4">
              ...
              <input type="password" class="form-control" id="mdp" name="mdp" value="<?=$users->mdp?>" >
              <small></small>
            </div>
          ...
          <button class="w-100 btn btn-primary btn-lg mb-2" type="submit" id="liveToastBtn" >Enregistrer les modifications</button>
